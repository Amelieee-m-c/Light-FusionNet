"""Aggregates the 3-seed SVM C=10.0 rerun (see run_phase2_svmC10.ps1) into the
same summary format as run_all_seeds.py's baseline aggregation."""
import json
...
all_results = []
for seed in SEEDS:
    with open(RUNS / f"seed{seed}" / "svmC10" / "phase2_results.json") as f:
...
with open(RUNS / "summary_3seeds_svmC10.json", "w") as f:
    json.dump(summary, f, indent=2)

print("\n=== 3-seed SVM-C10 summary (mean +/- std, %) ===")
...
print(f"\nsaved: {RUNS / 'summary_3seeds_svmC10.json'}")
