"""Aggregates the 3-seed dense256 feature-layer rerun (see run_phase2_dense256.ps1)
...
all_results = []
for seed in SEEDS:
    with open(RUNS / f"seed{seed}" / "dense256" / "phase2_results.json") as f:
...
with open(RUNS / "summary_3seeds_dense256.json", "w") as f:
    json.dump(summary, f, indent=2)

print("\n=== 3-seed dense256 summary (mean +/- std, %) ===")
...
print(f"\nsaved: {RUNS / 'summary_3seeds_dense256.json'}")
